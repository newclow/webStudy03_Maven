...
public class ReflectionUtil {
	...
	public static List<Class<?>> getClassesWithAnnotationAtBasePackages(
	...
	public static List<Method> getMethodsAtClass(
			Class<?> targetClz, Class<?> returnType, Class<?>...parameterTypes){
	...
	public static List<Method> getMethodsWithAnnotationAtClass(
			Class<?> targetClz, Class<? extends Annotation> annotationType, Class<?> returnType, Class<?>...parameterTypes){
