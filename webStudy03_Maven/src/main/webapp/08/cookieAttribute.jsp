...
<pre>
	...
	2. domain/host : 저장된 쿠키의 재전송 여부를 결정할 때 사용.
			 ...
			 도메인의 레벨 구조에 따라 ".naver.co.kr" 방식으로 설정함.
	3. maxAge : 만료 시간, 생략하면, 기본값으로 세션의 만료시간이 반영됨.
			-1 : 브라우저의 종료 시점에 삭제.
			0 : 기존의 쿠키가 있을 경우, 해당 쿠키를 삭제할때 사용.
				(maxAge 를 제외한 나머지 설정이 모두 동일한 경우.)
